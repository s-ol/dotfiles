{
  "colors": {
    ...
    "_bg": [0,"{{background[1:]}}"],
    "_black0": [0, "{{black[1:]}}"],
    "_black1": [8, "{{alt_black[1:]}}"],
    "_red0": [1, "{{red[1:]}}"],
    "_red1": [9, "{{alt_red[1:]}}"],
    "_green0": [2, "{{green[1:]}}"],
    "_green1": [10, "{{alt_green[1:]}}"],
    "_yellow0": [3, "{{yellow[1:]}}"],
    "_yellow1": [11, "{{alt_yellow[1:]}}"],
    "_blue0": [4, "{{blue[1:]}}"],
    "_blue1": [12, "{{alt_blue[1:]}}"],
    "_magenta0": [5, "{{magenta[1:]}}"],
    "_magenta1": [13, "{{alt_magenta[1:]}}"],
    "_cyan0": [6, "{{cyan[1:]}}"],
    "_cyan1": [14, "{{alt_cyan[1:]}}"],
    "_white0": [7, "{{white[1:]}}"],
    "_white1": [15, "{{alt_white[1:]}}"],
